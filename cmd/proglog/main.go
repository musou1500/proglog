...
import (
	...
	"github.com/musou1500/proglog/internal/agent"
...
func setupFlags(cmd *cobra.Command) error {
	...
	cmd.Flags().String("bind-addr", "127.0.0.1:8400", "Address to bind Serf on.")
	cmd.Flags().Int("rpc-port", 8400, "Port for RPC clients")
